...
Status: Historical V1 PRD
Historical context: Gmail-first PRD before provider-aware reporting, ProtonMail read-only flows, unsubscribe slices, and later operating-model work
Superseded by: `docs/v2-alignment.md` for current direction and `docs/checkpoints/current-operating-model-2026-06-22.md` for current shipped state

This document remains the requirements record for the original Gmail MVP slices.
