...
- LinkedIn `jobs-noreply@linkedin.com` mail with subjects like `Cezary, apply now to ‘AI Product Manager at Quectel’` classifies to `job-related`.
- LinkedIn `jobs-noreply@linkedin.com` mail with subjects like `Cezary, apply to Product Manager at Scrive and more` classifies to `job-related`.
