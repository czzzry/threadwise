...
async function refreshOpenMailTabsAfterVersionChange() {
  ...
  const mailTabs = await chrome.tabs.query({
    url: ["https://mail.google.com/*", "https://mail.proton.me/*"],
  });
...
refreshOpenMailTabsAfterVersionChange().catch(() => undefined);
