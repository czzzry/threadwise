...
This repo maps the default triage roles to public-facing labels: `needs-triage`, `needs-info`, `ready`, `needs-verification`, and `wontfix`. See `docs/agents/triage-labels.md`.
