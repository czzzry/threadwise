...
class GmailCompanionUiTests(unittest.TestCase):
    ...
    def test_extension_uses_harness_state_and_clickable_summary_filters(self) -> None:
        ...
        self.assertIn("Proposed future rule", content_js)
        ...
        self.assertIn("Select label (optional)", content_js)
        self.assertIn("Pick a label when you know it. Otherwise just describe what should change.", content_js)
        ...
        self.assertIn("Also apply broader rule", content_js)
        self.assertIn("Show affected emails", content_js)
        self.assertIn("Use for future emails only", content_js)
        self.assertIn("Keep discussing", content_js)
        self.assertIn("fixes the current message first", content_js)
    ...
    def test_panel_html_is_minimizable_and_contains_local_harness_controls(self) -> None:
        ...
        self.assertIn("Also apply broader rule", page)
