...
class FixtureBatchClassifierTests(unittest.TestCase):
            ...
            [
                {
                    "message_id": "gmail-live-001",
                    "sender": "LinkedIn <jobs-noreply@linkedin.com>",
                    "subject": "Cezary, apply now to ‘AI Product Manager at Quectel’",
                    "snippet": "Apply to your saved jobs.",
            ...
            [
                {
                    "message_id": "gmail-live-001",
                    "sender": "LinkedIn <jobs-noreply@linkedin.com>",
                    "subject": "Cezary, apply to Product Manager at Scrive and more",
    ...
    def test_classify_messages_marks_young_mailroom_memo_as_low_value(self) -> None:
        review_queue = self.classifier.classify_messages(
            ...
            [
                {
                    "message_id": "gmail-live-001",
                    "sender": '"Young, Jenny" <youngje@gbgh.on.ca>',
            ...
            [
                {
                    ...
                    "body": (
                        "Hi Cezary, welcome to Premium Lite on YouTube. Your payment method will be charged "
            ...
            [
                {
                    ...
                    "body": (
                        "Hi Cezary, danke für den Einkauf bei Yoga Barn Berlin. "
            ...
            [
                {
                    ...
                    "body": (
                        "Hallo Cezary, der Lieferstatus fuer deine Bestellung bei Mein Lieblingsrahmen hat sich "
    ...
    def test_classify_messages_marks_batch_31_account_security_variants(self) -> None:
        cases = [
            ...
            },
            {
                ...
                "subject": "Cezary, a new email address was added to your account",
                "snippet": "A new email address was added.",
                "body": "The email address cbaraniecki@protonmail.com was recently added to your LinkedIn account.",
            },
            {
                "sender": "LinkedIn <security-noreply@linkedin.com>",
                "subject": "Cezary, here's your PIN 349599",
    ...
    def test_classify_messages_marks_batch_35_follow_on_families(self) -> None:
        cases = [
            ...
            {
                "sender": "Pantak  uae <uaepantak@freemail.hu>",
                ...
                "body": (
                    ...
                    "or pantakgroupsuae@gmail.com for further evaluation."
                ),
                "expected_labels": ["spam-low-value"],
            },
            {
    ...
    def test_classify_messages_marks_university_of_europe_followups_as_low_value(self) -> None:
        cases = [
            {
                "sender": "Hannah Klein <hannah.klein@ue-germany.com>",
    ...
    def test_classify_messages_marks_batch_37_shipping_and_order_families(self) -> None:
        cases = [
            ...
            },
            {
                ...
                "body": "Hello Cezary, We've accepted your return request. Once we've received the item below, we'll issue your refund.",
            },
            {
    ...
    def test_classify_messages_marks_batch_37_low_value_personal_and_reply_needed_families(self) -> None:
        cases = [
            ...
            {
                "sender": "Samiksha Shrivastava <samiksha.shrivastava@ue-germany.com>",
            ...
            },
            {
                ...
                "body": "Bonjour Cezary, Votre avis compte pour nous suite à la livraison de votre commande.",
                "expected_labels": ["spam-low-value"],
            },
            {
                "sender": " IMF iData <idata@imf.org>",
            ...
            {
                "sender": "Melissa Riding <melissacriding@gmail.com>",
            ...
            {
                "sender": "Kyle RD <kyle_rd@outlook.com>",
                "subject": 'Kyle RD shared the folder "Photos with Andrew" with you',
                "snippet": "Kyle RD invited you to access a folder.",
                "body": "Kyle RD invited you to access a folder. Here's the folder that Kyle RD shared with you.",
                "expected_labels": ["personal"],
            },
            {
                "sender": "Tyler Godbolt <tyler@godbolt.ca>",
    ...
    def test_classify_messages_marks_batch_38_low_value_and_personal_families(self) -> None:
        cases = [
            ...
            },
            {
                ...
                "subject": "Cezary, your November update",
    ...
    def test_classify_messages_marks_batch_39_account_and_order_families(self) -> None:
        cases = [
            ...
            },
            {
                ...
                "subject": "Hi Cezary, we noticed a new sign in to your Dropbox account",
    ...
    def test_classify_messages_marks_batch_39_personal_low_value_and_job_families(self) -> None:
        cases = [
            ...
            {
                "sender": "Alec McAlister <alec.mcalister@gmail.com>",
            ...
            {
                "sender": '"Steve & Lyne" <ridings@rogers.com>',
    ...
    def test_classify_messages_marks_batch_40_low_value_personal_and_finance_families(self) -> None:
        cases = [
            ...
            {
                "sender": '"Gîte l\'Oasis" <giteoasis@gmail.com>',
    ...
    def test_classify_messages_marks_batch_41_low_value_booking_and_personal_families(self) -> None:
        cases = [
            ...
            },
            {
                ...
                "subject": "Cezary, enrol and contribute and watch your TFSA grow tax-free!",
    ...
    def test_classify_messages_marks_batch_42_low_value_and_newsletter_families(self) -> None:
        cases = [
            ...
            },
            {
                ...
                "subject": "Cezary, get only the hunts you want!",
    ...
    def test_classify_messages_marks_batch_43_families(self) -> None:
        cases = [
            ...
            {
                "sender": "David Smock <davsmock@gmail.com>",
            ...
            {
                "sender": "Daniel Cole <dancole@zoho.com>",
    ...
    def test_classify_messages_marks_batch_44_pending_families(self) -> None:
        cases = [
            ...
            {
                "sender": "Olivia <olivia@agilemailer.com>",
    ...
    def test_classify_messages_marks_batch_45_pending_families(self) -> None:
        cases = [
            ...
            {
                "sender": "Sebastian Schulze <se.sebastian.schulze@gmail.com>",
    ...
    def test_classify_messages_marks_batch_46_pending_families(self) -> None:
        cases = [
            ...
            {
                "sender": "Nicole Kruckmeyer <nkruckmeyer@snap.com>",
